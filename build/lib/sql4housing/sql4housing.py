...
Usage:
  sql4housing.py bulk_load
  sql4housing.py hud <site> [--d=<database_url>] [--t=<table_name>]
  sql4housing.py socrata <site> <dataset_id> [--a=<app_token>] [--d=<database_url>] [--t=<table_name>]
  sql4housing.py csv <location> [--d=<database_url>] [--t=<table_name>]
  sql4housing.py excel <location> [--d=<database_url>] [--t=<table_name>]
  sql4housing.py shp <location> [--d=<database_url>] [--t=<table_name>]
  sql4housing.py geojson <location> [--d=<database_url>] [--t=<table_name>]
  sql4housing.py census (decennial2010 | (acs [--y=<year>])) <variables> (--m=<msa> | --c=<csa> | --n=<county> | --s=<state> | --p=<place>) [--l=<level>] [--d=<database_url>] [--t=<table_name>]
  sql4housing.py (-h | --help)
  sql4housing.py (-v | --version)
