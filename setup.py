...
setup(
  ...
  version = 'v0.0.1-alpha',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/sunlightpolicy/sql4housing/archive/v0.0.1-alpha.tar.gz',    # I explain this later on
